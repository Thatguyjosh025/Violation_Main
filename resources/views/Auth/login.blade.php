...
$('#loginModal').on('hidden.bs.modal', function () {
    ...
    $('#login_email').removeClass('is-invalid'); // Remove error class
    $('#login_password').removeClass('is-invalid'); // Remove error class
    $('#emailError').text('');  // Remove error message
    $('#passwordError').text('');  // Remove error message
});
});
</script>
